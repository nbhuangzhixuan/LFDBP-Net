...
class TrainDataset(Dataset):
    def __init__(self, root_dir, level, season, user_transform=None):
        ...
        cloudy_season_path = os.path.join(root_dir, level, season, "train", 'cloudy')
        self.cloudy_image_paths = [os.path.join(cloudy_season_path, img_name) for img_name in
                                   os.listdir(cloudy_season_path)]

        gt_season_path = os.path.join(root_dir, level, season, "train", 'clean')
...
class TestDataset(Dataset):
    def __init__(self, root_dir, level, season, user_transform=None):
        ...
        path = os.path.join(root_dir, level, season, "test", 'cloudy')
        for img_name in os.listdir(path):
            self.image_paths.append(os.path.join(path, img_name))
