...
from models.NAF_block.models import lr_scheduler as lr_scheduler
from models.NAF_block.utils.dist_util import master_only

logger = logging.getLogger('NAF_block')
