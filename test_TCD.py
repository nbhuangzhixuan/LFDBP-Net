...
from datasets.TCD_datasets import TestDatasets
...
decloudnet_weight_path = os.path.join("output_result/TCD_weights","decloud_net.pth")
decloud_net.load_state_dict(torch.load(decloudnet_weight_path))

print('===> Loading test datasets')

test_dataset = TestDatasets(root_dir=args.dataset_root, isTrain=False,y_name='clean')
